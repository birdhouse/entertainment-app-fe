    ...
    <section className={styles.navBar}>
      <section className={styles.navIconsAll}>
        ...
        <div className={styles.navIcons}>
          <NavLink
            to="/"
            className={({ isActive }) => (isActive ? styles.iconActive : styles.defIcon)}
          >
            <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="#5A698F">
          ...
          <NavLink
            ...
            className={({ isActive }) => (isActive ? styles.iconActive : styles.defIcon)}
          >
            <svg width="17" height="20" xmlns="http://www.w3.org/2000/svg" fill="#5A698F">
